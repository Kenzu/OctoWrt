...
---
  ...
  ```
  wget https://github.com/Kenzu/OctoWrt/raw/main/scripts/1_format_extroot.sh
  ...
  ```
  wget https://github.com/Kenzu/OctoWrt/raw/main/scripts/2_octoprint_install.sh
...
<details>
 ...
 #### 1. Extroot:
  First execute [this](https://github.com/Kenzu/OctoWrt/blob/main/scripts/1_format_extroot.sh) script. Make sure you have a microsd card inserted as this step creates an extroot filesytem overlay on the card to expand the available space. Here's the code to fetch the script and run it.
