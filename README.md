...
<details>
  ...
  ## ⚠️ [Click Here For Firmware](https://github.com/Kenzu/KlipperWrt/tree/v4.2.1/Firmware/OpenWrt_snapshot) ⚠️
...
---
  ...
  ```
  wget https://github.com/Kenzu/OctoWrt/raw/24.10.4-110/scripts/1_format_extroot.sh
  ...
  ```
  wget https://github.com/Kenzu/OctoWrt/raw/24.10.4-110/scripts/2_octoprint_install.sh
...
<details>
 ...
 #### 1. Extroot:
  First execute [this](https://github.com/Kenzu/OctoWrt/blob/24.10.4-110/scripts/1_format_extroot.sh) script. Make sure you have a microsd card inserted as this step creates an extroot filesytem overlay on the card to expand the available space. Here's the code to fetch the script and run it.
...
cd src
wget https://github.com/Kenzu/OctoWrt/raw/23.05.3-150/octoprint/noargon2.patch
